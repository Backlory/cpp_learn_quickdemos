...
void tasker_cpp::task11(){
    const char temp[] = "asdasdads";
...
void tasker_cpp::task2(int a=5, float b=6.9, char c='q'){
    std::cout<<a<<b<<c<<std::endl;
}

void tasker_cpp::task1(){
    class Student{
    public:
        char name[100];
        int age;
